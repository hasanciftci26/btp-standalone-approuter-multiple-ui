		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI 2",
									"targetURL": "#ndbstraininghtml5ui2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ndbstraininghtml5ui2-display": {
								"semanticObject": "ndbstraininghtml5ui2",
								"action": "display",
								"description": "UI 2",
								"title": "UI 2",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ndbs.training.html5ui2",
									"url": sap.ui.require.toUrl("ndbs/training/html5ui2")
								}
							}
						}
					}
